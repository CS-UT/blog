...
![استگانوگرافی با متن](images/steganography/steg-cat-text.png)

شما همچنین می‌تونید یک تصویر دوم رو توی تصویر اول پنهان کنید.

![استگانوگرافی با تصویر](images/steganography/steg-cat-image.png)

## تشخیص استگانوگرافی

پس می‌تونیم متن و تصویر رو پنهان کنیم، چطوری می‌تونیم بفهمیم که آیا داده‌های پنهانی وجود داره؟

![گروهی از تصاویر](images/steganography/steg-a-b-c-d.png)
...
![فرآیند استگانوگرافی - مرحله 1](images/steganography/steg-step-1.png)

تغییر کم‌اهمیت‌ترین بیت (LSB) مقدار رو خیلی تغییر نمیده. نهایتا یکی به عدد اضافه یا یکی ازش کم میکنه.

![فرآیند استگانوگرافی - مرحله 2](images/steganography/steg-step-2.png)
...
![تفاوت 1 بیتی](images/steganography/lsb-color-difference.png)

### مثال

فرض کنید یک تصویر داریم و بخشی از اون شامل binary زیره:

![فرآیند استگانوگرافی - مرحله 3](images/steganography/steg-step-3.png)

و فرض کنید می‌خوایم کاراکتر y رو توی اون پنهان کنیم.

ابتدا باید پیام پنهان شده رو به binary تبدیل کنیم.

![فرآیند استگانوگرافی - مرحله 4](images/steganography/steg-step-4.png)

حالا هر بیت رو از پیام پنهان شده برمی‌داریم و LSB بایت مربوطه رو با اون جایگزین می‌کنیم.

![فرآیند استگانوگرافی - مرحله 5](images/steganography/steg-step-5.png)

و دوباره:

![فرآیند استگانوگرافی - مرحله 6](images/steganography/steg-step-6.png)

و دوباره:

![فرآیند استگانوگرافی - مرحله 7](images/steganography/steg-step-7.png)

و دوباره:

![فرآیند استگانوگرافی - مرحله 8](images/steganography/steg-step-8.png)

و دوباره:

![فرآیند استگانوگرافی - مرحله 9](images/steganography/steg-step-9.png)

و دوباره:

![فرآیند استگانوگرافی - مرحله 10](images/steganography/steg-step-10.png)

و دوباره:

![فرآیند استگانوگرافی - مرحله 11](images/steganography/steg-step-11.png)

و یک بار دیگر:

![فرآیند استگانوگرافی - مرحله 12](images/steganography/steg-step-12.png)
